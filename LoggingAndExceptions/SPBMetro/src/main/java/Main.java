/*
The aim of this homework is to learn how to parse json files, work with logging markers (log4j) and write UnitTests
for the program.

A program imitating the metro of St.Petersburg. You can enter the station of departure and the station of arrival
and the program will show the route, connection stations and calculate time of the trip.

The list of the stations, as well as the connections are gotten from the .json file.

The log markers registrate search history, input errors and exceptions.
 */
import core.Line;
import core.Station;
